...
class InputUserNameController: UIViewController {
    ...
    private func request() {
        ...
        userInfoReq.queryUserInfo(account: userNameTextField.text!)
    }
    ...
    private func goLoginOrRegister(userModel: Any) {
        ...
        guard let vc = UIStoryboard.init(name: "Login", bundle: Bundle.main).instantiateViewController(withIdentifier: "Login") as? LoginViewController else {
            return
        }
        vc.userInfo = model
