...
class AccountManager: NSObject, NSCoding {
    ...
    public var authority: Authority = .Ordinary
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.authority = Authority(rawValue: aDecoder.decodeObject(forKey: "authority") as! String)!
    ...
    func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(self.authority.rawValue, forKey: "authority")
